...
export const skills: Skill[] = [
  ...
  },
  {
    ...
    items: ["Azure DevOps Pipelines", "AWS (EC2, S3)", "GCP"],
  },
  {
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    highlights: [
      "Successfully delivered and deployed to production",
      "Client satisfied with performance and security implementation",
      "Implemented encrypted and secure healthcare data workflows",
  ...
  {
    id: 6,
    title: "Ordis Healthcare Management System",
    description:
      "AI-powered healthcare system for nurse handover and reporting automation",
    technologies: [
      "React.js (TSX)",
      "Node.js",
      "Express.js",
    ...
    highlights: [
      "Automates nurse handover documentation using voice recording",
      "Integrated Whisper AI for speech-to-text transcription",
      "Used OpenAI for intelligent report generation and summaries",
      "Admin dashboard to manage nurses, roles, and hospital data",
      "CMS integration for dynamic content and workflow management",
      "Reduces manual documentation effort and improves accuracy",
    ],
    category: "Web",
    status: "Ongoing",
  },
...
export const certificates: Certificate[] = [
  ...
  //   },
  {
    ...
    description:
      "Completed full stack Java development training, covering Java, Spring Boot, SQL, and front-end technologies.",
  },
